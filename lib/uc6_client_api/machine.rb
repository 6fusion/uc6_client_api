...
module UC6
  class Machine
    ...
    def get(id=nil, synch='false')
      http_response = @client.make_request("get", REST_NOUN, REST_SUB_NOUN, id, nil, synch)
    ...
    def update()
      http_response = @client.make_request("put", REST_NOUN, REST_SUB_NOUN, id, self.to_hash, true)
